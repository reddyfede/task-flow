...
urlpatterns = [
    ...
    path("tasks/team/<int:team_id>/",  views.team_task_detail, name="team_task_detail"),
    path("tasks/<int:task_id>/assign/<int:user_id>/",  views.task_add_user, name="task_add_user"),
